...
<?php } ?>
  ...
  foreach ($fname as $key => $value) { ?>
			<li>
				<p>&nbsp;<?php echo htmlspecialchars($value['username'], ENT_QUOTES, 'UTF-8');?></p>
			</li>
			<?php  } 
  } ?>
			<li>
				<p><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=follow'; ?>">好友管理</a></p>
			</li>
		</ul>
