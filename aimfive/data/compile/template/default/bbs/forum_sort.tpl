...
<!--design role="segment" id="linkdemo"/-->
	...
	<div class="middleside1" style="width:570px;padding-top:10px;">
		<div class="paixu" style="width:550px">
			<div class="content_filter" ><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=sort&order=postdate'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order == 'postdate'), ENT_QUOTES, 'UTF-8');?>">最新发帖</a><span>|</span><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=forum&a=sort&order=lastpost'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order != 'postdate'), ENT_QUOTES, 'UTF-8');?>">最后回复</a></div>
				<h3>提问分享</h3>	
			</div>
				<?php  if ($threadList) { ?>
				<ul class="askSel">
