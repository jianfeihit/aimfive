...
<div class="tac"> </div>
	...
	<?php }?>
				...
				<div class="reg_activation_tip">
					...
					如确认无法找到您的激活邮件，可<a id="J_re_send" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=u&c=register&a=sendActiveEmailAgain&_statu=', rawurlencode($_statu); ?>" class="s4">重新发送激活邮件</a>，也可<a id="J_email_change_btn" href="#" class="s4">更改邮箱地址</a>，用其他的邮箱再收一封新的激活邮件。</p>
				</div>
			</div>
		</div>
		<div id="J_email_change_wrap" class="core_pop_wrap" style="display:none;">
			<div class="core_pop">
				<div style="width:380px;">
					<form id="J_email_form" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=u&c=register&a=editEmail'; ?>" method="post">
